...
class StellarClient {
    ...
    constructor(network = 'testnet') {
        this.config = (0, networkConfig_1.getNetworkConfig)(network);
        this.server = new stellar_sdk_1.SorobanRpc.Server(this.config.rpcUrl);
     ...
     */
    updateRpcEndpoint(rpcUrl) {
        console.info(`[StellarClient] Updating RPC endpoint to: ${rpcUrl}`);
        this.server = new stellar_sdk_1.SorobanRpc.Server(rpcUrl);
    }
}
